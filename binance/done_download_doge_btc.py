...
print ("DOGE")
klines_doge = get_historical_klines("DOGEUSDT", "1m", "28. Dec 2020")
print ("BTC")
klines_btc = get_historical_klines("BTCUSDT", "1m", "28. Dec 2020")
...
with open('data_doge.csv', 'w') as f:
    ...
    write = csv.writer(f)
    write.writerows(klines_doge)

with open('data_btc.csv', 'w') as f:

    # using csv.writer method from CSV package
    write = csv.writer(f)
    write.writerows(klines_btc)
