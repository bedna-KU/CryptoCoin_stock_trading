...
ap.add_argument ("-x", "--symbol", type = str, required = True,
	help = "symbol for download")
ap.add_argument ("-s", "--start", type = str, required = True,
	help = "start date for download")
ap.add_argument ("-e", "--end", type = str, required = False,
...
print ("Data saved!")
with open('btc_for_predict.csv', 'w') as f:
